...
//    {
//        public event passwordDel passwordUpperEvent;
//        public event passwordDel passwordLowerEvent;
//        public event passwordDel passwordSpecialEvent;
//        public event passwordDel passwordRepeatedEvent;
//        public event passwordDel passwordDigitEvent;
//        public event passwordDel passwordNumberEvent;

//        public void Question3app(string password)
//        {
//            if (passwordUpperEvent != null)
//            {
//                passwordUpperEvent.BeginInvoke(password, null, null);
//            }
//            if (passwordLowerEvent != null)
//            {
//                passwordLowerEvent.BeginInvoke(password, null, null);
//            }
//            if (passwordSpecialEvent != null)
//            {
//                passwordSpecialEvent.BeginInvoke(password, null, null);
//            }
//            if (passwordDigitEvent != null)
//            {
//                passwordDigitEvent.BeginInvoke(password, null, null);
//            }
//            if (passwordNumberEvent != null)
//            {
//                passwordNumberEvent.BeginInvoke(password, null, null);
//            }
//            if (passwordRepeatedEvent != null)
//            {
//                passwordRepeatedEvent.BeginInvoke(password, null, null);
//            }
//        }
